...
public class FHomeActivity extends Activity {
    ...
    protected void onResume() {
        ...
        if(currentState.level == 0){
            ...
            descriptionText.setText(getString(log.bewell.login.R.string.you_have_no_plan));
        }else{
            ...
            if(currentState.lastWorkoutWeek > 0)
                ...
                lastWorkoutText.setText(getString(log.bewell.login.R.string.none));
            ...
            if(currentState.nextWorkoutWeek > 0)
                ...
                nextWorkoutText.setText(getString(log.bewell.login.R.string.none));

            if(currentState.isFinished == true)
            {
                descriptionText.setText(getString(log.bewell.login.R.string.you_finished_plan));
                startButton.setVisibility(View.VISIBLE);
                startNewButton.setVisibility(View.GONE);
                continueButton.setVisibility(View.GONE);
                nextWorkoutText.setText(getString(log.bewell.login.R.string.none));
            }else{
                descriptionText.setText(getString(log.bewell.login.R.string.current_plan_details));
            }
        }
    }
